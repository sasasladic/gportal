        ...
        <div class="row" style="background-color: #fdfdfd;">
            ...
            <div class="col-sm-3"><!--left col-->
                ...
                <div class="text-center">
                    <img src="{{$data->image->path }}" class="avatar img-circle
                         img-thumbnail"
                         alt="{{$data->image->alt}}" style="height: 210px;width: 220px;">
                </div>
                <br>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body"><a href="https://google.com">google.com</a></div>
                </div>
